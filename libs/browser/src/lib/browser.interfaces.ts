...
export type SkillStepMethod = 'loadUrl' | 'click' | 'inputText' | 'sleep' | 'scroll' | 'dataExtraction' | 'loop' | 'saveOnFile' | 'if' | 'test' | 'switchToFrame' | 'switchToDefaultContent' | "pressKey" | "clickByText" | "scroll";
